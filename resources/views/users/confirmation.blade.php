    ...
    <article class="container mx-auto max-w-7xl">
        ...
        <section
            ...
            <div class="grid grid-cols-12">
                ...
                <p class="col-span-12 md:col-span-10 xl:col-span-11 text-gray-500">{{ $user->name }}</p>
            </div>

            <div class="grid grid-cols-12">
                <p class="col-span-12 md:col-span-2 xl:col-span-1 text-gray-500">Email: </p>
                <p class="col-span-12 md:col-span-10 xl:col-span-11 text-gray-500">{{ $user->email }}</p>
            </div>

            <div class="grid grid-cols-12">
                <p class="col-span-12 md:col-span-2 xl:col-span-1 text-gray-500">Last Login: </p>
                <p class="col-span-12 md:col-span-10 xl:col-span-11 text-gray-500">{{ $user->login_at ?? "---" }}</p>
            </div>

            <div class="grid grid-cols-12">
                <p class="col-span-12 md:col-span-2 xl:col-span-1 text-gray-500">Status: </p>
                <p class="col-span-12 md:col-span-10 xl:col-span-11 text-gray-500">{{ $user->status ?? "---" }}</p>
            </div>
            ...
            <div class="grid grid-cols-12">
                ...
                <form class="col-span-12 md:col-span-10 xl:col-span-11 flex flex-row gap-2 items-center "
                    ...
                    <a href="{{ route('users.index') }}"
                            class="p-1 px-2 text-center rounded-md
                                           text-green-600 hover:text-red-200 dark:hover:text-black bg-red-200 dark:bg-black hover:bg-red-500
                                           duration-300 ease-in-out transition-all">
                        <i class="fa fa-trash text-lg"></i>
                        <span>Cancel</span>
                    </a>
